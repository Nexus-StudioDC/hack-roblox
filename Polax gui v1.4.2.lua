...
rede = Color3.fromRGB(140, 0, 255) -- Purple
tef = "SourceSans"
whit = Color3.new(255/255,255/255,255/255)
local cka = Instance.new("ScreenGui", game.CoreGui)
cka.Name= "CoolGui"
cka.IgnoreGuiInset = true
-- PASSWORD GATE (lightweight)
local pwGui = Instance.new("Frame", cka)
pwGui.Size = UDim2.new(1,0,1,0)
pwGui.BackgroundColor3 = Color3.new(0,0,0)
pwGui.BackgroundTransparency = 0.2
pwGui.ZIndex = 999

local pwBox = Instance.new("TextBox", pwGui)
pwBox.Size = UDim2.new(0.4,0,0.08,0)
pwBox.Position = UDim2.new(0.3,0,0.4,0)
pwBox.PlaceholderText = "Şifre gir"
pwBox.Text = ""
pwBox.TextScaled = true
pwBox.ClearTextOnFocus = false
pwBox.BackgroundColor3 = Color3.new(0,0,0)
pwBox.BorderColor3 = rede
pwBox.BorderSizePixel = 3
pwBox.TextColor3 = whit
pwBox.ZIndex = 1000

local pwInfo = Instance.new("TextLabel", pwGui)
pwInfo.Size = UDim2.new(0.6,0,0.06,0)
pwInfo.Position = UDim2.new(0.2,0,0.5,0)
pwInfo.Text = ""
pwInfo.TextScaled = true
pwInfo.BackgroundTransparency = 1
pwInfo.TextColor3 = whit
pwInfo.ZIndex = 1000

local pwBtn = Instance.new("TextButton", pwGui)
pwBtn.Size = UDim2.new(0.2,0,0.06,0)
pwBtn.Position = UDim2.new(0.4,0,0.58,0)
pwBtn.Text = "Giriş"
pwBtn.TextScaled = true
pwBtn.BackgroundColor3 = blak
pwBtn.BorderColor3 = rede
pwBtn.BorderSizePixel = 3
pwBtn.TextColor3 = whit
pwBtn.ZIndex = 1000

pwBtn.MouseButton1Click:Connect(function()
	if pwBox.Text == "polax" then
		pwGui:Destroy()
	else
		pwInfo.Text = "Şifre yanlış! Discord: https://discord.gg/MxeyH6aVnm"
	end
end)
...
local cope = Instance.new("TextButton")
	...
	cope.Position = UDim2.new(0.02,0,0.82,0)
	cope.Selectable = true
	cope.Size = UDim2.new(0.35,0,0.05,0)
cope.TextScaled = true
	cope.ZIndex = 3
...
title.TextScaled = true
	title.Text = "polax gui by riest and c00l"
...
-- EXTRA ADMIN LOADS (as buttons)
local btnNA = Instance.new("TextButton", acg)
btnNA.Size = UDim2.new(0.5,-6,0,30)
btnNA.Position = UDim2.new(0,3,0,66)
btnNA.Text = "Nameless Admin"
btnNA.TextScaled = true
btnNA.BackgroundColor3 = blak
btnNA.BorderColor3 = rede
btnNA.BorderSizePixel = 3
btnNA.TextColor3 = whit
btnNA.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NamelessAdmin/main/Source'))()
end)

local btnJD = Instance.new("TextButton", acg)
btnJD.Size = UDim2.new(0.5,-6,0,30)
btnJD.Position = UDim2.new(0.5,3,0,66)
btnJD.Text = "John Doe Admin"
btnJD.TextScaled = true
btnJD.BackgroundColor3 = blak
btnJD.BorderColor3 = rede
btnJD.BorderSizePixel = 3
btnJD.TextColor3 = whit
btnJD.MouseButton1Click:Connect(function()
...
spawn(function()
	...
	rs.RenderStepped:Connect(function(dt)
		t += dt
		frame.Rotation = math.sin(t*1.5) * 1.5
	end)
end)
